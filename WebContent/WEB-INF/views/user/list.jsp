            ...
            <tbody>
                <c:forEach var="user" items="${users}">
                    <tr>
                        ...
                        <td>${user.phone}</td>
                        <td>
                            <span class="status ${user.status eq 'Голосовал' ? 'voted' : 'not-voted'}">
                                ${user.status}
                            </span>
                        </td>
                        <td>
                            <a href="${pageContext.request.contextPath}/user/view/${user.id}" class="btn small">Просмотр</a>
                            <a href="${pageContext.request.contextPath}/user/edit/${user.id}" class="btn small">Редактировать</a>
                            <a href="${pageContext.request.contextPath}/user/delete/${user.id}" class="btn small danger"
